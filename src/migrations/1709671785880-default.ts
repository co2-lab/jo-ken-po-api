...
export class Default1709671785880 implements MigrationInterface {
    name = 'Default1709671785880'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "desafios" ("id" SERIAL NOT NULL, "esolhaDoUsuarioCriador" text NOT NULL, "escolhaDoUsuarioAceitou" text NOT NULL, "id_criador" integer, "id_acetou" integer, CONSTRAINT "PK_04126745b4c93c5e5be5a639bb0" PRIMARY KEY ("id"))`);
